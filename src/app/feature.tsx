...
//     children:
//       "Faites confiance à une communauté fiable. Nos vendeurs sont vérifiés pour garantir des transactions sécurisées et une expérience sans stress.",
//   },
//   {
//     // icon: HeartIcon,
//     icon: (
...
//     children:
//       "Discutez directement avec les acheteurs et vendeurs grâce à notre système de messagerie intégré. Négociez, posez vos questions et concluez vos affaires en toute transparence.",
//   },
//   {
//     // icon: LockClosedIcon,
//     icon: (
...
//     children:
//       "Suivez vos annonces et vos ventes en temps réel. Recevez des notifications pour rester informé de chaque nouvelle opportunité",
//   },
//   {
//     icon: (
//       <Image
//         src="/vitrine_pro.gif"
//         alt="Vitrines Professionnelles"
//         width={144}
//         height={144}
//         className="rounded-3xl object-cover"
//       />
//     ),
//     title: "Vitrines Professionnelles",
//     children:
//       "Donnez de la visibilité à votre entreprise grâce à votre vitrine professionnelle personnalisée. Présentez vos produits, vos services et vos offres spéciales directement sur la marketplace pour toucher une audience ciblée et augmenter vos ventes.",
//   },
...
//         >
//           Achetez et vendez en toute simplicité, où que vous soyez. Que vous soyez dans les transports, en train d’attendre un ami ou que vous ayez juste quelques minutes devant vous,
//           notre application s’intègre parfaitement à votre quotidien.
//         </Typography>
//       </div>
